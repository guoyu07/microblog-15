...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-9" style="margin-left: 30px;width: 945px">
            <div class="well">
                <p style="color: #08c;font-weight: bold;">邀请配置</p>
                <hr/>
                ...
                <!--邮件邀请-->
                <form class="form-horizontal" role="form" style="margin-top: 10px;display: none">
                    <div class="form-group">
                        <p class="col-sm-2 control-label">请输入用户邮箱</p>
